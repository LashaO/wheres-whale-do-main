...
class MultiHeadNet(nn.Module):
    def __init__(self, CFG, pretrained=False):
        ...
        if (
            ...
            or CFG.model_name == "tf_efficientnet_b4_ns"
            or CFG.model_name == "tf_efficientnet_b5_ns"
            or CFG.model_name == "tf_efficientnet_b7_ns"
        ):
            ...
            if CFG.mt_type == "arcface_adaptive":
                self.margin = ArcMarginProduct_subcenter(
                    CFG.embedding_size, CFG.individual_ids_num_classes, k=CFG.k
                )
        #                 self.margin = ArcFaceLossAdaptiveMargin(CFG.margins,CFG.individual_ids_num_classes,CFG.s)

        if (
            CFG.model_name == "convnext_small"
            or CFG.model_name == "convnext_base"
            or CFG.model_name == "convnext_large"
            or CFG.model_name == "convnext_base_384_in22ft1k"
            or CFG.model_name == "convnext_xlarge_in22k"
            or CFG.model_name == "convnext_xlarge_384_in22ft1k"
        ):
            ...
            if CFG.mt_type == "cls":
                self.margin = nn.Linear(
                    CFG.embedding_size, CFG.individual_ids_num_classes
                )
    ...
    def forward(self, x, individual_ids=None):
        if (
            self.CFG.model_name == "tf_efficientnet_b0_ns"
            or self.CFG.model_name == "tf_efficientnet_b4_ns"
            or self.CFG.model_name == "tf_efficientnet_b5_ns"
            or self.CFG.model_name == "tf_efficientnet_b7_ns"
        ):
        ...
        if (
            self.CFG.model_name == "convnext_small"
            or self.CFG.model_name == "convnext_base"
            or self.CFG.model_name == "convnext_large"
            or self.CFG.model_name == "convnext_base_384_in22ft1k"
            or self.CFG.model_name == "convnext_xlarge_in22k"
            or self.CFG.model_name == "convnext_xlarge_384_in22ft1k"
        ):
            x = self.model.stem(x)
